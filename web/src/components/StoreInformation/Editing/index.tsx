...
import { getDistrictsFromApi, getCitiesFromApi } from '../../../store/actions';
import './style.scss';
...
const Editing = React.memo((props: any) => {
  ...
  useEffect(() => {
    props.dispatch(getDistrictsFromApi());
  ...
  return (
    <>
      ...
      <Modal title={t('EDIT STORE PROFILE')} visible={open} width={1000} footer={null} onCancel={() => setOpen(false)}>
        <Row gutter={[16, 16]}>
